...
def create_app():
    ...
    app.add_url_rule("/classes/<string:class_code>/video/<string:video_code>/", view_func=view.video_page,
                     methods=["GET", "POST"])
    ...
    app.add_url_rule("/adminpanel/departments/delete/<string:department_code>", view_func=view.department_delete,
                     methods=["GET", "POST"])
    app.add_url_rule("/classes/<string:class_code>/addstudent/", view_func=view.student_add_page,
                     methods=["GET", "POST"])
    app.add_url_rule("/classes/<string:class_code>/deletestudent/<string:student_id>/",
                     view_func=view.delete_student_from_class, methods=["GET", "POST"])
    app.add_url_rule("/tutors/", view_func=view.tutor_list, methods=["GET", "POST"])
    app.add_url_rule("/classes/<string:class_code>/deletevideo/<string:video_code>/", view_func=view.delete_video,
                     methods=["GET", "POST"])
    app.add_url_rule("/classes/<string:class_code>/updateclass/", view_func=view.update_class_page,
                     methods=["GET", "POST"])
    app.add_url_rule("/classes/<string:class_code>/video/<string:video_code>/update", view_func=view.update_video_page,
                     methods=["GET", "POST"])
